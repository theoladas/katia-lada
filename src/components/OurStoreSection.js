  ...
  return (
    <Flex className="hero-section">
      ...
      <div className="hero-content">
        ...
        <h2 className="opening-hours">Ωράριο Λειτουργίας:</h2>
        <Paragraph>
          Δευτέρα <span></span>
        </Paragraph>
        <Paragraph>Τρίτη</Paragraph>
        <Paragraph>Τετάρτη</Paragraph>
        <Paragraph>Πέμπτη</Paragraph>
        <Paragraph>Παρασκευή</Paragraph>
